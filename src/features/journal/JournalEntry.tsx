...
export const JournalEntry: React.FC<JournalEntryProps> = ({ session, game }) => {
  ...
  // Parse notes if they are string (from DB)
  let notes: string[] = [];
  ...
  const gameCover = game?.cover_url;
